...
def main(key_path, key_id, seal_mode, seal_kek_path, eval_mode, preset):
    # Key Path
...
if __name__ == "__main__":
    ...
    parser.add_argument("--key_id", "--key-id", dest="key_id", type=str, default="test-key-seal-mm32-ip3", help="ID of the key to generate")
    ...
    main(args.key_path, args.key_id, args.seal_mode, args.seal_kek_path, args.eval_mode, args.preset)

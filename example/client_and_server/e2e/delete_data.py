...
def main(args):
    mode_to_preset = {"mm": "ip1", "mms": "ip1", "mm32": "ip2", "mms32": "ip2"}
    ...
    print("Triggering indexing and loading the index...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--index-name", type=str, default="test_delete_data_flat")
